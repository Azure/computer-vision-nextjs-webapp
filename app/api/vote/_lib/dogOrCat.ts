export async function dogOrCat(imageUrl: string): Promise<'dog' | 'cat' | null> {
  const { AZURE_COMPUTER_VISION_KEY: computerVisionKey, AZURE_COMPUTER_VISION_ENDPOINT: computerVisionEndPoint } =
    process.env;
